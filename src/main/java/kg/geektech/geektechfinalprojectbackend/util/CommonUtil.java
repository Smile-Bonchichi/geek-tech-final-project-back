                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                        <tr>
                                            <td align="left" bgcolor="#ffffff"
                                                ...
                                                <p style="margin: 0;">
                                                    Нажмите кнопку ниже, чтобы подтвердить свой адрес электронной почты. Если вы не
                                                    создавали учетную запись с помощью <a href="%url">Dostavka.kg</a>,
                                                    вы можете безопасно удалить это
                                                    электронное письмо.
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="left" bgcolor="#ffffff"
                                                ...
                                                <p style="margin: 0;">
                                                    С уважением <a href="%url">Dostavka.kg</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                        <tr>
                                            <td align="center" bgcolor="#e9ecef"
                                                ...
                                                <p style="margin: 0;">
                                                    Вы получили это письмо, потому что мы получили запрос на регистрацию для вашей
                                                    учетной записи. Если вы не запрашивали регистрацию, вы можете безопасно удалить
                                                    это письмо.
                                                </p>
                                            </td>
                                        </tr>
